...
document.body.append(break_creat());
document.body.append(label_creat("label","for","loc","Location:"));
document.body.append(break_creat());
document.body.append(input_creat("input","type","text","id","loc"));
document.body.append(break_creat());
document.body.append(break_creat());
document.body.append(button_creat("button","type","button","onclick","getvalues()","Submit"));